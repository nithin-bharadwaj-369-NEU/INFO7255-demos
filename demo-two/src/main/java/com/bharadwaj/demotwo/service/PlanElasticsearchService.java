...
@Service
public class PlanElasticsearchService {
    ...
    public PlanElasticsearchService(RestHighLevelClient client) {
        this.client = client;
    }
    ...
    public void deleteDocument(JSONObject jsonObject) throws IOException {
